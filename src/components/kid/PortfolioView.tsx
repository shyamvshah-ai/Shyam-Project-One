  ...
  return (
    <div className="space-y-4">
      ...
      <Card className="text-center">
        <div className="text-sm font-bold uppercase tracking-wide text-indigo-400">
          {kid.name}’s money is worth
        </div>
        <div className="my-1 text-5xl font-extrabold text-indigo-900 sm:text-6xl">
          {money(p.totalValue)}
        </div>
      ...
      <div>
        <div className="mb-2 flex items-center justify-between px-1">
          <h2 className="text-lg font-extrabold text-indigo-900">
            What {kid.name} owns{' '}
            <span className="text-indigo-300">({p.holdings.length})</span>
          </h2>
        </div>

        {p.holdings.length === 0 ? (
          <Card className="text-center text-indigo-500">
...
function MiniStat({
  ...
  const toneCls = tone === undefined ? 'text-indigo-900' : toneClasses(tone).text
  return (
    <div className="rounded-2xl bg-indigo-50/70 px-3 py-2 text-center">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-0.5 flex items-center gap-2">
            <span className="text-lg font-extrabold text-indigo-900">{money(view.value)}</span>
